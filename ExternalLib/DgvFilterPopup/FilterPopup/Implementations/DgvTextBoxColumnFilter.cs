    ...
    public partial class DgvTextBoxColumnFilter : DgvBaseColumnFilter {
        ...
        protected override void OnFilterInitializing(object sender, CancelEventArgs e) {
            ...
            if (ColumnDataType == typeof(string))
                comboBoxOperator.Items.AddRange (new object[] { "..xxx..","xxx..","..xxx" , "=", "<>", "= null", "<> null" });
            else
                comboBoxOperator.Items.AddRange(new object[] { "=", "<>", ">", "<", "<=", ">=", "= null", "<> null" });
        ...
        protected override void OnFilterExpressionBuilding(object sender, CancelEventArgs e){
            ...
            if (comboBoxOperator.Text == "= null") ResultFilterExpression = GetNullCondition(this.DataGridViewColumn.DataPropertyName);
            if (comboBoxOperator.Text == "<> null") ResultFilterExpression = GetNotNullCondition(this.DataGridViewColumn.DataPropertyName);
