        ...
        private void CreateColumnFilter(DataGridViewColumn c) {
            ...
            if (e.ColumnFilter==null) {
                ...
                if (c.DataPropertyName != "") {
                    ...
                    //if ("OrderId" == c.Name)
                    //    MessageBox.Show("c.Name = " + c.Name + "   c.GetType().Name = " + c.GetType().Name + "   DataType = " + DataType );
                    ...
                    switch (c.GetType().Name) {
                        ...
                        case "DataGridViewTextBoxColumn":
                            ...
                            else if (  IsNumeric(DataType))//  DataType.IsPrimitive && DataType != typeof(char) && DataType != typeof(bool))
                            {
